  ...
  return (
    <SafeAreaView className="flex-1 bg-slate-950 px-6 py-8">
      <View className="mt-10">
        <Text className="text-4xl font-semibold text-white">LoadGo Arunachal</Text>
        <Text className="mt-3 text-base text-slate-300">Sign in with your mobile number to book intra-city cargo rides.</Text>
      </View>
